<template>
  <div class="searchbar-content-wrapper" :class="{ active: assetStore.activeModalUnderlay }">
    ...
    <div class="searchbar-content-footer">
      <div class="footer-info">
        ...
        <p>Erstelle eigene Assets oder Gruppen, um dein Portfolio vollumfänglich abzubilden.</p>
      </div>
...
import InfoColumn from "@/components/asset/row/column/InfoColumn.vue";
